...
const pri = h2a('1fcce948db9fc312902d49745249cfd287de1a764fd48afb3cd0bdd0a8d74674885f642c8390293eb74d08cf38d3333771e9e319cfd12a21429eeff2eddeebd2');
...
const x1 = utils_1.expandSecret(utils_1.B(pri));
...
for (let i = 0; i < 1000; i++) {
    ...
    r.push((i >>> 8) & 0xff);
    r.push(i & 0xff);
    const P = ecvrf_1.hashToCurve(utils_1.B(r), pk);
    if (!P || P.isInfinity()) {
        console.log('not on curve', P);
        break;
    }
}
const pi2 = ecvrf_1.prove(pk, pri, m);
